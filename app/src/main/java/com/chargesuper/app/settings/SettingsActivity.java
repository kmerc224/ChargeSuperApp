package com.chargesuper.app.settings;
...
import com.chargesuper.app.PermissionCenterActivity;
import com.chargesuper.app.R;
import com.chargesuper.app.log.LogCapture;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void setupNavigationRows() {
        ...
        findViewById(R.id.row_log_viewer).setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, com.chargesuper.app.LogViewerActivity.class);
            startActivity(intent);
        });
        ...
        findViewById(R.id.row_about).setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, com.chargesuper.app.AboutActivity.class);
            startActivity(intent);
        });
    }
}
